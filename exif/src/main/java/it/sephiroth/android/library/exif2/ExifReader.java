            ...
            switch (event) {
                ...
                case ExifParser.EVENT_NEW_TAG:
                    ...
                    if (!tag.hasValue()) {
                        ...
                        if (parser.isDefinedTag(tag.getIfd(), tag.getTagId())) {
                            ...
                            System.out.println(TAG + "skip tag because not registered in the tag table:" + tag);
                        }
                    }
                    break;
                ...
                case ExifParser.EVENT_COMPRESSED_IMAGE:
                    ...
                    if (buf.length == parser.read(buf)) {
                        ...
                        System.out.println(TAG + "Failed to read the compressed thumbnail");
                    }
                    break;
                case ExifParser.EVENT_UNCOMPRESSED_STRIP:
                    ...
                    if (buf.length == parser.read(buf)) {
                        ...
                        System.out.println(TAG + "Failed to read the strip bytes");
                    }
                    break;
            }
            event = parser.next();
